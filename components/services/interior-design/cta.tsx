...
export default function InteriorDesignCta() {
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Let's collaborate to create a space that reflects your unique style and enhances your lifestyle. Contact us
            today to begin your interior design journey.
          </p>
        </motion.div>
