            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 col-md-12">
                        <div
                            className="ttm-bg ttm-col-bgcolor-yes ttm-left-span spacing-1 ttm-bgcolor-darkgrey z-index-2">
                                    ...
                                    >
                                        <div className="slick-list draggable">
                                            <div className="slick-track" style={{
                                                opacity: 1,
                                                width: `${data.services_banner_set.length * 293}px`,
                                                            ...
                                                            >
                                                                ...
                                                                <div className="featured-content">
                                                                    ...
                                                                    <div className="featured-title">
                                                                        <h3>
                                                                            <Link
                                                                                href={`/services/${service.service.slug}`}>{service.name}</Link>
                                                                        </h3>
                                                                    </div>
