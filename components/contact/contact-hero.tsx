...
export default function ContactHero({banner_title, banner_slogan, banner_description}: {
    ...
    return (
        <section ref={ref} className="relative h-[60vh] md:h-[70vh] overflow-hidden">
            ...
            {/* Gold accent lines */}
            <div
                className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-gold/20 to-transparent"></div>
            <div
                className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-gold/20 to-transparent"></div>
            ...
            <span
              ...
              {banner_slogan}
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-6xl lg:text-7xl font-extralight mb-6 tracking-tight text-gold"
                    >
                        {banner_title}
                    </motion.h1>
