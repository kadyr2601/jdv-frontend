...
export default function AboutHero({banner_image, banner_description,banner_slogan, banner_title}: {
    banner_image: string,
    ...
    return (
        <section ref={ref} className="relative h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                >
                    <Image
                        src={process.env.API_URL+banner_image}
                        alt="Luxury Texture"
                        fill
            ...
            {/* Content */}
            <div
                className="container mx-auto px-4 md:px-6 relative z-10 h-full flex flex-col justify-center items-center">
                <motion.div style={{opacity}} className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="overflow-hidden mb-6">
                        ...
                        >
              <span
                  className="inline-block text-gold uppercase text-sm tracking-[0.3em] font-light px-6 py-2 border border-gold/20 rounded-full backdrop-blur-sm">
                {banner_slogan}
              </span>
                        </motion.div>
                    </div>
