...
export default function AboutPhilosophy() {
  ...
  const tabs = [
    {
      ...
      content:
        "We believe that the spaces we inhabit have the power to shape our lives. Our designs are not just aesthetically pleasing but practical and sustainable, creating spaces that evolve with our clients' needs while maintaining timeless elegance.",
      image: "/about-ph3.jpg",
    },
    {
      title: "Our Approach",
      content:
        "What distinguishes us is our deeply personalized approach and unwavering commitment to understanding our clients' lifestyles before designing. We combine technical expertise with artistic vision, employing a collaborative process that keeps clients involved throughout.",
      image: "/about-ph2.jpg",
    },
    {
      title: "Our Promise",
      content:
        "We are committed to delivering excellence in every aspect of our work. From concept to completion, we are dedicated to craftsmanship, creativity, and attention to detail, ensuring that each project exceeds our clients' expectations.",
      image: "/about-ph1.jpg",
    },
  ]
  ...
  return (
    <section ref={containerRef} className="py-32 bg-[#030303] relative overflow-hidden">
      ...
      {/* Diagonal lines */}
      <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-gold/10 to-transparent transform rotate-12 origin-top" />
      <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-gold/5 to-transparent transform -rotate-12 origin-top" />
      ...
      <div ref={ref} className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4">
            We Sculpt <span className="text-gold">Enriched Lifestyles</span>
          </h2>

          <p className="text-white/70 max-w-2xl mx-auto">
            At our interior design company, we sculpt enriched lifestyles through inspired design. We believe that the
            spaces you inhabit should reflect your aspirations and enhance your daily experiences.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                >
                  ...
                  <div className="mt-2 h-1 bg-[#222] overflow-hidden">
                    <motion.div
                      ...
                      transition={{ duration: 1.5, delay: index * 0.2 + 0.8, ease: [0.25, 1, 0.5, 1] }}
                    />
                  </div>
                </motion.div>
              ))}
          ...
          >
            <div className="relative aspect-video overflow-hidden">
              ...
              <div className="absolute top-0 left-0 w-16 h-16 border-t border-l border-gold/40 z-20"></div>
              <div className="absolute bottom-0 right-0 w-16 h-16 border-b border-r border-gold/40 z-20"></div>
